...
# A fork of glimmer components is included, we must copy the manifest first
COPY --chown=user:user ./vendor/glimmer-component/package.json ./vendor/glimmer-component/package.json
